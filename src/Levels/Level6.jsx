...
const Level6 = ({ onNext }) => {
  const initialDeck = new Map([
    ...
    ['five', 'IV'],
    ['five', 'SC'],
    ['five', 'Inj. Hydrocortisone'],
    ['five', 'Inj. Promethazine'],
    ['five', 'Inj. Prochlorperazine'],
  ]);

  const correctSequence = ['one', 'two', 'three']; // Correct sequence for Level 3
  const [deck, setDeck] = useState([]);
  const [result, setResult] = useState([]);
  const [selectedCards, setSelectedCards] = useState([{}, {}, {}]); // Change to 3 slots instead of 2
      ...
      <div className="flex flex-col items-center">
        <div>
          <h2 className="text-center text-2xl font-bold text-blue-400">
            AVS reaction: Scalp Itching/Hypotension/Abdomen Pain/Vomiting/Urticaria         
          </h2>
