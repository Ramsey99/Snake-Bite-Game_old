...
const Level15 = ({ onNext }) => {
  const initialDeck = new Map([
    ['one', 'Discharge after 24 hours'],
    ['two', 'Discharge after 4 hours of observation'],
    ['three', 'Keep admitted and in observation for atleast 72 hours'],
    ['four', 'Transfer to referal hospital']
  ]);
