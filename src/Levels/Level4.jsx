...
const Level4 = ({ onNext }) => {
  const initialDeck = new Map([
    ['one', 'AVS'],
    ['two', '10 vials in 1 hour'],
    ['three', '5 vials in 30 minutes'],
    ['four', '15 vials in 1 hour'],
    ['five', '1 vial in 30 minutes'],
    ['six', 'Transfer the patient immediately'],
    ['seven', 'Measure AVS according to body weight'],
    ['eight', 'AVS slow IV over 24 hours'],
  ]);
