...
const Level11 = ({ setCompletedLevels }) => {
  ...
  const handleCompleteLevel11 = () => {
    ...
    const completedLevels = { level1: true, level2: true, level3: true, level4: true, level5: true, level6:true, level7: true, level8:true, level9:true, level10:true, level11:true, level12: false };
  ...
  return (
    <div>
      <div className="flex flex-col items-center">
        <div>
          <h2 className="text-center text-2xl font-bold text-blue-400 mr-20">
          Clotted:
          </h2>
